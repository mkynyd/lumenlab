...
export const documentBlockSchema = z.discriminatedUnion("kind", [
  ...
  z.object({ kind: z.literal("abstract"), id: nonEmpty.optional(), language: z.enum(["zh", "en"]), children }).strict(),
  ...
  z.object({ kind: z.literal("acknowledgement"), id: nonEmpty.optional(), children }).strict(),
