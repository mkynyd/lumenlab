...
export const DEFAULT_QUICK_ACTIONS: Record<ProjectType, QuickActionDefinition[]> = {
  ...
  review: [
    ...
    { title: "生成 Mermaid 思维导图", prompt: "请基于我选中的资料生成 Mermaid mindmap 思维导图，覆盖主要章节、核心概念和关系。注意：节点标签中不要使用半角括号 () 逗号 , 和竖线 |，改用全角符号；每行一个节点不要同行多语句；同时给出可直接复制的 Mermaid 代码块，不要添加资料外的知识点。" },
  ],
  coding: [
