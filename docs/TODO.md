...
- [x] Upgrade deterministic LaTeX import to parse standard metadata, abstract/keywords, section hierarchy and labels, equations, tables, lists, quotes, page breaks, inline citation/cross-reference/footnote marks, and known bibliography commands; preserve custom macros/environments and standalone external-image Figure environments as low-confidence RawLaTeXBlock records instead of inventing invalid FileAsset IDs.
